...
const Order = () => {
  ...
  const OrderGetter = async () => {
    ...
    if (user[0]) {
      try {
        const data = await axios.post("https://e-commerce-14z8.onrender.com/user/OrderGetter", { Email: Email }, { withCredentials: true })
  ...
  const Orderdeleteis=  axios.post("https://e-commerce-14z8.onrender.com/user/OrderDelete",{deleteOrderid:data.product._id,UserOrderEmail:userData[0].emailAddress},{withCredentials:true})
  console.log("daleted response is the ",Orderdeleteis.data)
  }

// https://e-commerce-14z8.onrender.com/user/
